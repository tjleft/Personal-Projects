...
public class PlayerInput {
	...
	public PlayerInput(Shot newShot, int shotID) {
	    ...
	    ActionListener l = new ActionListener() {
	    	public void actionPerformed(ActionEvent e) {
	    		newShot.setPlayerID(Integer.parseInt(e.getActionCommand()), 0);
				frame.dispose();
				PositionInput test = new PositionInput(newShot, shotID);
	    	}
	    };
